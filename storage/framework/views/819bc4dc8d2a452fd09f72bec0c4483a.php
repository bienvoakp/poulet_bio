<?php $__env->startSection('title', 'Modifier un animal'); ?>
<?php $__env->startSection('description', 'Dans cette page, vous pouvez modifier les informations de l\'animal'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form class="row gy-4" action="<?php echo e(route('animaux.update', $animal->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\COURS IFRI\MON MEMOIRE\poulet_bio\resources\views/admin/animal/edit.blade.php ENDPATH**/ ?>