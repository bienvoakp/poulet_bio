...
<div class="<?php echo e($class); ?>">
    <div class="form-group">
        ...
        <div class="form-control-wrap">
            <input value="<?php echo e($defaultValue); ?>" class="form-control" <?php echo e($attributes->except(['value', 'id', 'class', 'name'])); ?>

                id="<?php echo e($inputId); ?>" name="<?php echo e($inputName); ?>">
        </div>
