...
<?php $__env->startSection('description', 'Modifiez un utilisateur ici'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form class="row gy-4" action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\COURS IFRI\MON MEMOIRE\poulet_bio\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>