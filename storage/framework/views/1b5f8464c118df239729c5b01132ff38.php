                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs" style="">
                                    <ul class="link-list-plain">
                                        <li><a href="<?php echo e(route('animaux.edit', $animal->id)); ?>" class="text-primary d-flex justify-content-center"><i class="fas icon fa-marker"></i>Modifier</a></li>

                                        <li><a href="<?php echo e(route('animaux.show', $animal->id)); ?>" class="text-primary d-flex justify-content-center"><i class="fas icon fa-eye"></i>Voir</a></li>

                                        <li><a href="<?php echo e(route('animaux.destroy', $animal->id)); ?>" class="text-danger d-flex justify-content-center" onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer cet animal ?')) document.getElementById('delete-animal-<?php echo e($animal->id); ?>').submit();"><i class="fas icon text-danger fa-trash"></i>Supprimer</a></li>
