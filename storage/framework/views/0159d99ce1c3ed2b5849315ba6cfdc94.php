    ...
    <div class="form-group">
        ...
        <div class="form-control-wrap">
            <input
                type="file"
                class="form-control"
                <?php echo e($attributes->except(['value', 'id', 'class', 'name'])); ?>
...
<?php /**PATH D:\COURS IFRI\MON MEMOIRE\poulet_bio\resources\views/components/admin/form-input-file.blade.php ENDPATH**/ ?>