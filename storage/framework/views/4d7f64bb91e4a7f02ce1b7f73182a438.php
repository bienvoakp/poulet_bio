<?php $__env->startSection('title', 'Tous vos nutriments'); ?>
<?php $__env->startSection('description', 'Visualisez tous les nutriments disponibles que vous avez créées '); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.primary-link','data' => ['href' => ''.e(route('nutriments.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('nutriments.create')).'']); ?>Ajouter <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?> <?php echo e($nutriments->firstItem() + $key); ?>  <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?> <?php echo e($nutriment->titre); ?>  <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaleca1dccf8d8f432f50f17071a804c199)): ?>
<?php $attributes = $__attributesOriginaleca1dccf8d8f432f50f17071a804c199; ?>
<?php unset($__attributesOriginaleca1dccf8d8f432f50f17071a804c199); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?> <?php echo e($nutriment->desc); ?>  <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaleca1dccf8d8f432f50f17071a804c199)): ?>
<?php $attributes = $__attributesOriginaleca1dccf8d8f432f50f17071a804c199; ?>
<?php unset($__attributesOriginaleca1dccf8d8f432f50f17071a804c199); ?>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs" style="">
                                ...
                                <ul class="link-list-plain">
                                    ...
                                    <li><a href="<?php echo e(route('nutriments.edit', $nutriment->id)); ?>" class="text-secondary d-flex justify-content-center"><i class="fas fa-marker"></i></a></li>

                                    <li><a href="<?php echo e(route('nutriments.show', $nutriment->id)); ?>" class="text-info d-flex justify-content-center"><i class="fas fa-eye"></i></a></li>

                                    <li><a href="<?php echo e(route('nutriments.destroy', $nutriment->id)); ?>" class="text-danger d-flex justify-content-center" onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer ce nutriment ?')) document.getElementById('delete-nutriment-<?php echo e($nutriment->id); ?>').submit();"><i class="fas fa-trash"></i></a></li>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\COURS IFRI\MON MEMOIRE\poulet_bio\resources\views/admin/nutriment/index.blade.php ENDPATH**/ ?>