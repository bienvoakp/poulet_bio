...
<?php $__env->startSection('title', 'Ajouter un niveau de maturité'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.primary-link','data' => ['href' => ''.e(route('animaux.show', ['animaux' => $animaux])).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('animaux.show', ['animaux' => $animaux])).'']); ?>Retour <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form class="row gy-4" action="<?php echo e(route('animaux.niveau-maturite.store', ['animaux' => $animaux])); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <?php endif; ?>
         ...
         <?php echo $__env->make('admin.animal.niveau_maturite._partials.form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\COURS IFRI\MON MEMOIRE\poulet_bio\resources\views/admin/animal/niveau_maturite/create.blade.php ENDPATH**/ ?>