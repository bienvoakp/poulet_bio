...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                    ...
                                    <div class="row g-gs">
                                                ...
                                                <div class="col-lg-6 col-xxl-12">
                                                    <div class="card card-bordered">
                                                        <div class="card-inner">
                                                            <div class="mb-2 card-title-group align-start">
                                                            ...
                                                            <div class="flex-wrap align-end gy-3 gx-5 flex-md-nowrap flex-lg-wrap flex-xxl-nowrap">
                                        ...
                                        <div class="col-xxl-6">
                                            <div class="card card-bordered h-100">
                                                <div class="card-inner">
                                                    <div class="mb-3 card-title-group align-start gx-3">
                                                        <div class="card-title">
                                                    ...
                                                    <div class="justify-between nk-sale-data-group align-center gy-3 gx-5">
                                                        <div class="nk-sale-data">
                                                    ...
                                                    <div class="pt-4 nk-sales-ck large">
                                        ...
                                        <div class="col-xxl-8">
                                            <div class="card card-bordered card-full">
                                                ...
                                                <div class="p-0 card-inner border-top">
                                                ...
                                                <div class="text-center card-inner-sm border-top d-sm-none">
                            ...
                            <div class="nk-footer-links">
                                <ul class="nav nav-sm">
                                    <li class="nav-item dropup">
                                        <a href="#" class="text-base dropdown-toggle dropdown-indicator has-indicator nav-link" data-bs-toggle="dropdown" data-offset="0,10"><span>English</span></a>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    <h5 class="mb-4 title">Select Your Country</h5>
                    <div class="nk-country-region">
                        <ul class="text-center country-list gy-2">
                            <li>
    ...
    <script src="./assets/js/charts/gd-default.js?ver=3.1.0"></script>
</body>
